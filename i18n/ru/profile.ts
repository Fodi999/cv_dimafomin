...
export const profile = {
  ...
  collectiveInsight: {
    title: "🧠 Как думают другие повара на вашем этапе",
    subtitle: "Анонимные наблюдения на основе решений других пользователей",
    footer: "Анонимно агрегировано из активности сообщества",
    insights: [
      "Многие пользователи уровня 1 сейчас больше фокусируются на управлении холодильником, чем на новых рецептах.",
      "Часто возникает потребность упростить техники, а не усложнять их.",
      "Это хорошее время, чтобы начать контролировать затраты без потери вкуса.",
    ],
  },
  ...
  settings: {
    ...
    sections: {
      core: {
        label: "Основные",
        description: "Язык, время, единицы",
      },
      ai: {
        label: "AI & Ментор",
        description: "Стиль ассистента",
      },
      notifications: {
        label: "Уведомления",
    ...
    general: {
      ...
      timeFormatDescription: "Выберите формат отображения времени",
